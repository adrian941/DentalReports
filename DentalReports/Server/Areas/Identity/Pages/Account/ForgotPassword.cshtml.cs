        ...
        public async Task<IActionResult> OnPostAsync()
        {
            if (ModelState.IsValid)
            {
                ...
                await SendEmailAsync(
                    Input.Email,
                    "Reset Password",
                    $"Hello {user.FirstName},<br /><br />Please reset your password by <a href='{HtmlEncoder.Default.Encode(callbackUrl)}'>clicking here</a>." +
                    $"<br /><br />" +
        ...
        private async Task<bool> SendEmailAsync(string ToEmail, string Subject, string Body)
        {
            ...
            try
            {
                ...
                using (MimeMessage mailService = new MimeMessage())
                {
                    ...
                    mailService.Body = new TextPart(TextFormat.Html) { Text = Body };
